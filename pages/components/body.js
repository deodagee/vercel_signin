...
import xsmStyles from "../../styles/components/body_xsm_mobile.module.css";
...
function Body() {
  ...
  return (
    <>
      <div className={`${styles.whole} ${xsmStyles.whole_xsm}`}>
          ...
          <ol className={styles.everything_wrapper}>
            ...
            <div className={styles.separatorLine}></div>
              ...
              <ul className={styles.avatar_image_items} >
                <li>
                  <Image
                    className={styles.avatar_image_1}
                    width={50}
                    height={50}
                    alt="avatar"
                    src="/bgwhole8.jpg">
                ...
                <li>
                  <Image
                    className={styles.avatar_image_2}
                    width={50}
                    height={50}
                    alt="avatar"
                    src="/Deo.jpg">
                ...
                <li>
                  <Image
                    className={styles.avatar_image_3}
                    width={50}
                    height={50}
                    alt="avatar"
                    src="/bgwhole6.jpg">
            ...
            <div className={styles.pricing}>
              ...
              <div className={ styles.pricing_tabs_parent}>
