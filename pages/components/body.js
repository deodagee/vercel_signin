        ...
        <div className={styles.parent_wrapper}>
          ...
          <div class={styles.tabber}>
            <ul className={styles.body_list}>
              <li className={styles.description_wrapper} >
                <div  >
              ...
              <table className={styles.tabber_buttons}>
                <tr>
                  <td>
                    <button>
                ...
                <tr>
                  ...
                  <td>
                    <button>
                      <p class={styles.projects_more_button}>Projects {" >"}</p>
                    </button>
                  </td>
                </tr>
                <tr>
                  <td>
                    <button>
                      <p class={styles.more_more_button}>More {" >"}</p>
                    </button>
                  </td>
                  <td>
                    <button>
          ...
          <div className={styles.promo_and_stuff}>
            ...
            <ul className={styles.and_more_stuff}>
              <li className={styles.perks_title}>
                <h1 className={styles.perks_header}>Perks Included:</h1>
              </li>
              <span className={styles.offered_list}>

                <li className={styles.ssl_logo}>
                  <Link href={"/services"}>
                    <div>
                      <Image
                    ...
                    <div className={styles.more_tag}> SSL Security</div>
                  </Link>
                </li>
                ...
                <li className={styles.ssl_logo}>
                  <Link href={"/services"}>
                    <div>
                      <Image
                        className={styles.logo_private_domain_logo}
                        width={50}
                        height={50}
                        alt="logo"
                        src="/sslsecurity.jpg"
                ...
                <li className={styles.private_domain_logo}>
                  <Link href={"/services"}>
                    <div>
                      <Image
                        className={styles.logo_private_domain_logo}
                    ...
                    <div className={styles.more_tag}>Private Domains</div>
                  </Link>
                </li>
              </span>
            </ul>
              ...
              {displayUI === 'group_52374' && (
                ...
                <div className={styles.group_52374}>
                  ...
                  <div className={styles.frame_405}>
                    ...
                    <div className={styles.frame_403}>

                      <div className={styles.frame_401}>
                    ...
                    <div className={styles.frame_408}>
                      <div className={styles.frame_401}>
                        <div className={styles.frame_402}>
                          <div className={styles.frame_52391}>
                    ...
                    <div className={styles.frame_4073}>
                      <div className={styles.frame_401}>
                        <div className={styles.frame_402}>
                    ...
                    <div className={styles.frame_410}>
                      <div className={styles.frame_401}>
                        <div className={styles.frame_402}>
